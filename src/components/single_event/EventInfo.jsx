...
const Eventinfo = ({ event, onEdit }) => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <h1 className="text-center mb-5 first-letter:capitalize">{event.title}</h1>
      ...
      <div className="grid grid-cols-3 py-10 gap-5 sm:py-14 sm:gap-18 md:py-18 md:gap-23 lg:py-20 lg:gap-28 text-center max-w-[1000px] mx-auto">
        <div className="flex flex-col items-center">
          <FiCalendar size={50} className="text-primary-red sm:w-17 md:w-20 lg:w-23 h-auto" strokeWidth={1.4} />
        ...
        <div className="flex flex-col items-center">
          <LuMapPin size={50} className="text-primary-red sm:w-17 md:w-20 lg:w-23 h-auto" strokeWidth={1.4} />
        ...
        <div className="flex flex-col items-center">
          <LuClock4 size={50} className="text-primary-red sm:w-17 md:w-20 lg:w-23 h-auto" strokeWidth={1.4} />
